...
export const en: Record<string, string> = {
  ...
  '在终端里跑的小工具，发到 npm 或打成二进制': 'A tool that runs in the terminal, published to npm or built as a binary',
  '桌面应用': 'Desktop app',
  'Windows / macOS 窗口程序，要打包和自动更新': 'A Windows / macOS window app, packaged with auto-update',
  '手机 App': 'Mobile app',
  'iOS / Android，要上架商店': 'iOS / Android, shipped to the app stores',
  '脚本、插件、库……走通用路线': 'Scripts, plugins, libraries… the generic route',
